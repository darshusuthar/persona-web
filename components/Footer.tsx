...
export default function Footer() {
  return (
    <footer className="foot-big foot-connect-sec" data-nav="light">
      <div className="wrap">
        <h2 className="foot-connect">Get in touch.</h2>
        <div className="foot-cta">
          <a href="mailto:darshansuthar@live.in" target="_blank" rel="noopener">Email ↗</a>
          <a href="https://www.linkedin.com/in/darshansuthar7/" target="_blank" rel="noopener">LinkedIn ↗</a>
